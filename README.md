SemVer4j is a Java implementation of the Semantic Versioning Specification
(http://semver.org/).
...
Usage
-----
Below are some common use cases for the SemVer4j library.

### Creating Versions ###
The main class of the SemVer4j library is `Version` which implements the
...
### Comparing Versions ###
Comparing versions with SemVer4j is easy. The `Version` class implements the
...
in mind. For such cases SemVer4j provides a _comparator_ `Version.BUILD_AWARE_ORDER`
...
----------------------
SemVer4j supports the SemVer Expressions API which is implemented as both
...
~~~ java
import io.github.romvoid95.semver4j.Version;
import static io.github.romvoid95.semver4j.expr.CompositeExpression.Helper.*;
...
[issue](https://github.com/ROMVoid95/semver4j/issues/1).
...
Exception Handling
------------------
There are two types of errors that may arrise while using SemVer4j
...
Bugs and Features
-----------------
Bug reports and feature requests can be submitted at https://github.com/ROMVoid95/semver4j/issues.


License
-------
SemVer4j is licensed under the MIT License - see the `LICENSE` file for details.
